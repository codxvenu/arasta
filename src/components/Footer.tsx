      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            <div>
              ...
              <p className="font-sans text-xs text-[#FAF8F3]/60 leading-relaxed font-light mt-6 max-w-sm">
                A scholarly custodianship dedicated to sourcing, conserving, and verifying absolute provenance for classical Indian bronzes, courtly manuscripts, ancient sculpture, and colonial royal furniture.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-3 text-[#C4B299]">
              ...
              <span className="font-mono text-[10px] tracking-[0.25em] uppercase font-medium">
                Serving Collectors Across India
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2.5 font-sans text-xs text-[#FAF8F3]/75 font-light">
                ...
                <button onClick={() => handleLinkClick('about-section')} className="text-left hover:text-[#C4B299] transition-colors cursor-pointer">Restoration Stewardship</button>
                <button onClick={() => handleLinkClick('authenticity-section')} className="text-left hover:text-[#C4B299] transition-colors cursor-pointer">Forensic Authenticity</button>
                <button onClick={() => handleLinkClick('consultation-section')} className="text-left hover:text-[#C4B299] transition-colors cursor-pointer">Advisory Inquiries</button>
              </div>
            </div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2 font-sans text-xs text-[#FAF8F3]/75 font-light">
                <div className="flex items-start space-x-2">
                  <MapPin size={12} className="text-[#8B6F47] mt-0.5 shrink-0" />
                  <span>Pavilion Arcade, Lavelle Road, Richmond Town, Bengaluru - 560001</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Phone size={12} className="text-[#8B6F47] shrink-0" />
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="font-mono text-[9px] text-[#FAF8F3]/40 tracking-wider">
            © {new Date().getFullYear()} The Heritage Pavilion Ltd. All rights reserved. Registered with Antiquities & Art Treasures Act, 1972.
          </div>
